...
export const fetchProducts = createAsyncThunk<ProductCardType[], 
{ 
...
export const productsSlice = createSlice({
  ...
  reducers: {
    setStatus: (state, action: 
      PayloadAction<{ sortBy?: FilterStatus, itemsPerPage?: ItemsPerPage, currentPage?: number}>) => {
    ...
    builder
      ...
      .addCase(fetchProducts.fulfilled, (state, action: PayloadAction<ProductCardType[]>) => {
