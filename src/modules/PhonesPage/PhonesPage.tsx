  ...
  return (
    ...
    <div
      className="grid grid-cols-4 gap-4 
        ...
        pt-16 pb-16
        min-[640px]:pt-20 min-[640px]:pb-16
        min-[1200px]:pt-20 min-[1200px]:pb-20 
        gap-y-0"
    >
      <div
      ...
      <div className="col-span-full grid grid-cols-[repeat(4,min-content)] gap-4 min-[640px]:grid-cols-[repeat(12,min-content)] min-[1200px]:grid-cols-[repeat(24,min-content)] pb-6">
        <div className="col-span-2 min-[640px]:col-span-4 min-[1200px]:col-span-4">
          <CustomDropdown
            placeholder="Newest"
        ...
        <div className="col-span-2 min-[640px]:col-span-3 min-[1200px]:col-span-3">
          <CustomDropdown
            placeholder="16"
